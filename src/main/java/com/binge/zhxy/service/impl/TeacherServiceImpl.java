...
import com.binge.zhxy.mapper.TeacherMapper;
...
public class TeacherServiceImpl extends ServiceImpl<TeacherMapper, Teacher> implements TeacherService {
    ...
    @Override
    public IPage<Teacher> getTeacherByOpr(Page<Teacher> pageParm, Teacher teacher) {
        QueryWrapper<Teacher> queryWrapper = new QueryWrapper<>();
        ...
        Page<Teacher> teacherPage = baseMapper.selectPage(pageParm, queryWrapper);
        return teacherPage;
    }
}
