...
import com.binge.zhxy.service.ClazzService;
...
public class ClazzController {
    ...
    @ApiOperation("d单个或批量删除班级信息")
    @DeleteMapping("/deleteClazz")
    public Result deleteClazz(
            @ApiParam("要删除的所有clazz的id的json集合") @RequestBody List<Integer> ids
    ){
    ...
    public Result saveOrUpdateClazz(
            @ApiParam("修改或添加的数据") @RequestBody Clazz clazz
    ){
