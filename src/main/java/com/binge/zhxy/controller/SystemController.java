...
public class SystemController {
    ...
    public Result headerImgUpload(
        ...
        //保存文件  讲文件发送到第三方/独立的图片服务器上
        String portraitPath = "D:/production/zhxy/target/classes/public/upload/".concat(newFileName);
        try {
    ...
    public Result login(@RequestBody LoginForm loginForm, HttpServletRequest request){
        ...
        if("".equals(sessionVerifiCode) || null == loginVerifiCode){
        ...
        switch (loginForm.getUserType()){
            case 1:
                try {
                    ...
                    if(admin != null){
                        //用户的Id和用户的类型转换成密文，以token的名称向客户端反馈
